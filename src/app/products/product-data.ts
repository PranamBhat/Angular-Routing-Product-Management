  ...
  createDb(): { products: Product[] } {
    ...
    const products: Product[] = [
      ...
      },
      {
        ...
        releaseDate: 'March 01, 2022',
        description: 'Elvin Rope',
        price: 32.99,
        cost: 10.00,
        starRating: 4.2,
        imageUrl: 'assets/images/rope.jpg',
        category: 'Camping'
      },
      {
        id: 5,
